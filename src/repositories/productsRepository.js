class productRepository {
    ...
    getProductsById = async (pid) => await this.daoService.getCartById(pid)

    productCreate = async ({title, price, category, description, stock, code, thumbnail, status}) => await this.daoService.productCreate ({title, price, category, description, stock, code, thumbnail, status})
